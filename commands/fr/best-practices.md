...
name: best-practices
description: >
  Ajoute des bonnes pratiques au fichier de reference .flow/docs/best-practices.md.
...
Les bonnes pratiques a ajouter : `$ARGUMENTS`

1. Ouvrir `.flow/docs/best-practices.md`. Si le fichier n'existe pas, le creer avec un titre `# Bonnes pratiques`.
2. Ajouter les bonnes pratiques decrites ci-dessus, formulees de maniere concise.
